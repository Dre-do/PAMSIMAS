...
class StudentObserver
{
    public function creating(Student $model)
    {
        ...
        Activity::record("Tambah Klien", ['original' => $model]);
    }
    ...
    public function updating(Student $model)
    {
        ...
        Activity::record("Ubah Klien", Activity::parse($model->getDirty(), $model->getOriginal()));
    }

    public function deleting(Student $model)
    {
        Activity::record("Hapus Klien", ['original' => $model->fill(['deleted_by' => Auth::id()])]);
