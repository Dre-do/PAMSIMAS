...
class RoomObserver
{
    public function creating(Room $model)
    {
        ...
        Activity::record("Tambah Wilayah", ['original' => $model]);
    }
    ...
    public function updating(Room $model)
    {
        ...
        Activity::record("Ubah Wilayah", Activity::parse($model->getDirty(), $model->getOriginal()));
    }

    public function deleting(Room $model)
    {
        Activity::record("Hapus Wilayah", ['original' => $model->fill(['deleted_by' => Auth::id()])]);
