        ...
        <div class="col-md-12">
            <div class="card" id="settings-card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row align-items-center">
                        <label class="form-control-label col-sm-2 text-md-right">Logo PAMSIMAS</label>
                        <div class="col-sm-6 col-md-9">
                        ...
                        <x-modals.modal id="img" title="Logo PAMSIMAS">
                            <form>
                                <x-slot name="body">
                                    <img src="{{ asset($logo) }}" alt="Logo PAMSIMAS" style="width: 100%;">
                                </x-slot>
                                <x-slot name="footer">
