...
class RolePermissionTableSeeder extends Seeder
{
    ...
    {
        // data master -------------------------------
        Permission::create(['module' => 'master', 'name' => 'manage_room', 'display_name' => 'Kelola Wilayah']);
        Permission::create(['module' => 'master', 'name' => 'manage_school_year', 'display_name' => 'Kelola Periode']);
        Permission::create(['module' => 'master', 'name' => 'manage_student', 'display_name' => 'Kelola Klien']);
