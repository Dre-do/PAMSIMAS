    ...
    <div class="card-header-action">
        ...
        <div class="dropdown d-inline mr-2">
            ...
            <div class="dropdown-menu dropdown-menu-right" x-placement="bottom-start">
                <a class="dropdown-item" data-toggle="modal" data-target="#import-modal" href="#">Import Klien</a>
                <a class="dropdown-item" href="{{ route('master.student.setting-status') }}">Kelola Status</a>
                <a class="dropdown-item" href="{{ route('master.student.setting-room') }}">Kelola Kenaikan Wilayah</a>
                <a class="dropdown-item" href="#" wire:click.prevent="downloadFormat">Download Format</a>
            </div>
        </div>
    </div>

    <x-modals.import id="import-modal" title="Import Klien" :file="$file" wire:model.defer='file' />
    <x-modals.modal title="Ubah status Klien" id="student-status">
        <x-slot name="body">
